...
export const metadata: Metadata = {
  title: 'Abhishek Parnandhi | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced video editor and graphic designer! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
