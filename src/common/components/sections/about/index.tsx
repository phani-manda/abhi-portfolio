          ...
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                  I&apos;m a Video Editor and a Graphic Designer.I develop high-quality video and graphic content, transforming raw concepts into polished visuals. I focus on clear storytelling and intuitive design to deliver user-centered experiences. I create consistent brand assets that engage viewers and communicate messages effectively across all platforms.
                </span>
                <span>
                  Seeking for Job and Freelancing opportunities where I can leverage
